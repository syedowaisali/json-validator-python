...
|   **\_\_upper\_\_**    | Apply uppercase constraint on text, and if both ```__upper__``` and ```__lower__``` constraints are defined then ```__upper__``` will take precedence over ```__lower__```.                                                                                                                                                                                                                                                                                        | ```false```  |                         `string`                          |
|   **\_\_lower\_\_**    | Apply lowercase constraint on value.                                                                                                                                                                                                                                                                                                                                                                                                                               | ```false```  |                         `string`                          |
...
|  **\_\_defaults\_\_**  | This is a special keyword and that will be used to apply the defined constraints globally on the document.<br /><br />**Available properties that could be set globally:**<br /><ol><li><code>\__allow_space\__</code></li><li><code>\_\_min_length\_\_</code></li><li><code>\_\_max_length\_\_</code></li><li><code>\_\_min_value\_\_</code></li><li><code>\_\_max_value\_\_</code></li><li><code>\_\_upper\_\_</code></li><li><code>\_\_lower\_\_</code></li></ol> |  ```none```  |                     only root `object`                     |
